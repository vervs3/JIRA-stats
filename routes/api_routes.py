    ...
    def special_jql():
        ...
        if chart_type == 'open_tasks':
            ...
            try:
                ...
                status_condition = "status in (" + ", ".join([f'"{status}"' for status in default_open_statuses]) + ")"
        ...
        logger.info(f"Generated special JQL for {chart_type}, project {project}: {final_jql}")
